...
useEffect(() => {
  ...
  console.log('check',QuestionList[currentquestion].incorrect_answers)
       return(
        ...
        <div className="btns">
           {
            ...
            {QuestionList[currentquestion].incorrect_answers.map((answerOption, index)=>(
                     <button onClick={() => handleCorrectAnswer(answerOption.isCorrect)}
                      key={index}>{answerOption}</button>   
            ))}
